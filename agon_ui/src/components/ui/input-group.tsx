...
// Note: this repo has no `Textarea` component and nothing here needs one, so
// `InputGroupTextarea` (present in shadcn's own input-group.tsx) is omitted —
// add it back the same way as `InputGroupInput` above if a future input-group
// usage needs a multi-line control.
